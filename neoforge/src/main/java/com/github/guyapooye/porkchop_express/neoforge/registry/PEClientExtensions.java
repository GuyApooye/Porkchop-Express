...
public final class PEClientExtensions {
    private static final Map<Supplier<? extends Item>, IClientItemExtensions> ITEM_EXTENSIONS = new Object2ObjectArrayMap<>();
    private static final Set<ResourceLocation> ITEMS_WITH_RENDERER = new ObjectArraySet<>();
    
    public static void register(RegisterClientExtensionsEvent event) {
        ITEM_EXTENSIONS.forEach(
                (item, extensions) -> event.registerItem(extensions, item.get())
        );
    }
    ...
    public static void addItemExtensions(Supplier<? extends Item> item, IClientItemExtensions extensions) {
